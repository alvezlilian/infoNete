...
public function nuevaNoticia($tituloNoticia,$subtitulo,$edicion,$seccionNoticia,$precioNoticia,$descripcionNoticia,$archivo){
       $sqlEstado="SELECT `id`FROM estadodepublicacion WHERE Estado='pendiente'";
       $estado=$this->database->query($sqlEstado);
       $valor=1;

        $sql="INSERT INTO nota( Titulo, Subtitulo, contenido, idSeccion, idEdicion,precio,Imagen,idEstado)
